...
document.addEventListener('DOMContentLoaded', () => {
    ...
    generateVoiceBtn.addEventListener('click', () => {
        ...
        // Stepwise loader status overlays
        waveformStatus.innerHTML = '<span>Initializing synthesis model...</span>';
        
        setTimeout(() => {
            waveformStatus.innerHTML = '<span>Calibrating neural node pipeline...</span>';
            
            setTimeout(() => {
                waveformStatus.innerHTML = '<span>Synthesizing voiceover stream...</span>';
